...
include 'foton-instagram-helper.php';

/**
 * Class FotonInstagramApi
 */
class FotonInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var FotonInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var FotonInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'foton_instagram_code';
	const USER_ID_OPTION_NAME = 'foton_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'foton_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'foton_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->helper       = new FotonInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see FotonInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 *
	 * @see FotonInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see FotonInstagramApi::getAccessToken()
	 */
