...
/**
 * Class FotonInstagramHelper
 */
class FotonInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines foton_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'foton_instagram_image_atts',
			array(
				'class'  => $imageSize,
