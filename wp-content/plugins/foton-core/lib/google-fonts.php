<?php
if ( ! function_exists( 'foton_mikado_init_google_fonts_array' ) ) {
    function foton_mikado_init_google_fonts_array() {
        ...
        $foton_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'foton_mikado_init_google_fonts_array');
}