...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'foton-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'foton-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'foton-core' ),
							'value'       => array(
								esc_html__( 'Title', 'foton-core' )          => 'title',
								esc_html__( 'Category', 'foton-core' )       => 'category',
								esc_html__( 'Tag', 'foton-core' )            => 'tag',
								esc_html__( 'Author', 'foton-core' )         => 'author',
								esc_html__( 'Date', 'foton-core' )           => 'date',
								esc_html__( 'Featured Image', 'foton-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
