...
namespace FotonCore\CPT\Shortcodes\PortfolioCategoryList;
...
class PortfolioCategoryList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio Category List', 'foton-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'value'       => array_flip( foton_mikado_get_number_of_columns_array( true, array( 'one' ) ) ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Items Per Page', 'foton-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'portfolio-category-holder', '', $params );
