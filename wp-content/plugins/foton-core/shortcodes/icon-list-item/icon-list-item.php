<?php
namespace FotonCore\CPT\Shortcodes\IconListItem;
...
class IconListItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Icon List Item', 'foton-core' ),
					'base'     => $this->base,
					...
					'params'   => array_merge(
						array(
							...
							array(
								...
								'heading'     => esc_html__( 'Icon List Item Bottom Margin (px)', 'foton-core' ),
						...
						array(
							...
							array(
								...
								'heading'    => esc_html__( 'Title Size (px)', 'foton-core' ),
							...
							array(
								...
								'heading'     => esc_html__( 'Title Left Padding (px)', 'foton-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_shortcode_module_template_part( 'templates/icon-list-item-template', 'icon-list-item', '', $params );
