<?php
namespace FotonCore\CPT\Shortcodes\SectionTitle;
...
class SectionTitle implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Section Title', 'foton-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Two Columns', 'foton-core' ) => 'two-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Title - Text Position', 'foton-core' ),
							'value'       => array(
								esc_html__( 'Title Left - Text Right', 'foton-core' ) => 'title-left',
								esc_html__( 'Title Right - Text Left', 'foton-core' ) => 'title-right'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Space Between Columns', 'foton-core' ),
							'value'       => array(
								esc_html__( 'Normal', 'foton-core' ) => 'normal',
								esc_html__( 'Small', 'foton-core' )  => 'small',
								esc_html__( 'Tiny', 'foton-core' )   => 'tiny'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'two-columns' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'position',
							'heading'     => esc_html__( 'Horizontal Position', 'foton-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Holder Side Padding (px or %)', 'foton-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
						...
						array(
							...
							'group'       => esc_html__( 'Title Style', 'foton-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Bold Font Weight', 'foton-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'foton-core' ),
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_tag',
							'heading'     => esc_html__( 'Text Tag', 'foton-core' ),
							'value'       => array_flip( foton_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'text', 'not_empty' => true ),
							'group'       => esc_html__( 'Text Style', 'foton-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Text Font Size (px)', 'foton-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'foton-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Text Line Height (px)', 'foton-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'foton-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Text Font Weight', 'foton-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_shortcode_module_template_part( 'templates/section-title', 'section-title', '', $params );
