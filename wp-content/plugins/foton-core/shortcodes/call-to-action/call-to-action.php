<?php
namespace FotonCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'foton-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'foton-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'foton-core' ),
							'value'      => array(
								esc_html__( '80/20', 'foton-core' ) => '80',
								esc_html__( '75/25', 'foton-core' ) => '75',
								esc_html__( '66/33', 'foton-core' ) => '66',
								esc_html__( '50/50', 'foton-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
							...
							'value'       => esc_html__( 'Button Text', 'foton-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'button_top_margin',
							'heading'    => esc_html__( 'Button Top Margin (px)', 'foton-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'foton-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'foton-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link Target', 'foton-core' ),
						...
						array(
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'foton-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
