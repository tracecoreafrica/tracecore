<?php
namespace FotonCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'foton-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'foton-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'foton-core' ) => 'grid',
								esc_html__( 'Masonry', 'foton-core' )    => 'masonry',
								esc_html__( 'Slider', 'foton-core' )     => 'slider',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'foton-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'foton-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
