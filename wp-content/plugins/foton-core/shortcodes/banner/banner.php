<?php
namespace FotonCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'foton-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'foton-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'foton-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'foton-core' )   => 'mkdf-visible-on-hover',
								esc_html__( 'Visible on Default', 'foton-core' ) => 'mkdf-visible-on-default',
								esc_html__( 'Disabled', 'foton-core' )           => 'mkdf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'foton-core' ),
							'value'       => array(
								esc_html__( 'Default', 'foton-core' )  => 'default',
						...
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'foton-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
							'heading'    => esc_html__( 'Subtitle', 'foton-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'subtitle_tag',
							'heading'     => esc_html__( 'Subtitle Tag', 'foton-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'foton-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'foton-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'foton-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'foton-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
