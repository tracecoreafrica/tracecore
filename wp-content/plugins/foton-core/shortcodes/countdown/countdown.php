<?php
namespace FotonCore\CPT\Shortcodes\Countdown;
...
class Countdown implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Countdown', 'foton-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Light', 'foton-core' )   => 'mkdf-light-skin',
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'year',
							'heading'     => esc_html__( 'Year', 'foton-core' ),
							'value'       => array(
								'2018' => '2018',
								'2019' => '2019',
								'2020' => '2020',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'month',
							'heading'     => esc_html__( 'Month', 'foton-core' ),
							'value'       => array(
								esc_html__( 'January', 'foton-core' )   => '1',
								esc_html__( 'February', 'foton-core' )  => '2',
								esc_html__( 'March', 'foton-core' )     => '3',
								esc_html__( 'April', 'foton-core' )     => '4',
								esc_html__( 'May', 'foton-core' )       => '5',
								esc_html__( 'June', 'foton-core' )      => '6',
								esc_html__( 'July', 'foton-core' )      => '7',
								esc_html__( 'August', 'foton-core' )    => '8',
								esc_html__( 'September', 'foton-core' ) => '9',
								esc_html__( 'October', 'foton-core' )   => '10',
								esc_html__( 'November', 'foton-core' )  => '11',
								esc_html__( 'December', 'foton-core' )  => '12'
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'day',
							'heading'     => esc_html__( 'Day', 'foton-core' ),
							'value'       => array(
								'1'  => '1',
								'2'  => '2',
								'3'  => '3',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hour',
							'heading'     => esc_html__( 'Hour', 'foton-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'minute',
							'heading'     => esc_html__( 'Minute', 'foton-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							...
							'heading'    => esc_html__( 'Month Label', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'day_label',
							'heading'    => esc_html__( 'Day Label', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'hour_label',
							'heading'    => esc_html__( 'Hour Label', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'minute_label',
							'heading'    => esc_html__( 'Minute Label', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'second_label',
							'heading'    => esc_html__( 'Second Label', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'digit_font_size',
							'heading'    => esc_html__( 'Digit Font Size (px)', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'label_font_size',
							'heading'    => esc_html__( 'Label Font Size (px)', 'foton-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_shortcode_module_template_part( 'templates/countdown', 'countdown', '', $params );
