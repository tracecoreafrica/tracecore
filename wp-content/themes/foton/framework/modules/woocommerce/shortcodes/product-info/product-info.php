<?php
namespace FotonCore\CPT\Shortcodes\ProductInfo;
...
class ProductInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product Info', 'foton' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Product', 'foton' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Product Info Type', 'foton' ),
							'value'       => array(
								esc_html__( 'Title', 'foton' )          => 'title',
								esc_html__( 'Featured Image', 'foton' ) => 'featured_image',
								esc_html__( 'Category', 'foton' )       => 'category',
								esc_html__( 'Excerpt', 'foton' )        => 'excerpt',
								esc_html__( 'Price', 'foton' )          => 'price',
								esc_html__( 'Rating', 'foton' )         => 'rating',
								esc_html__( 'Add To Cart', 'foton' )    => 'add_to_cart',
								esc_html__( 'Tag', 'foton' )            => 'tag',
								esc_html__( 'Author', 'foton' )         => 'author',
								esc_html__( 'Date', 'foton' )           => 'date',
							),
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Product Info Color', 'foton' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Featured Image Proportions', 'foton' ),
							'value'      => array(
								esc_html__( 'Default', 'foton' )        => '',
								esc_html__( 'Original', 'foton' )       => 'full',
								esc_html__( 'Square', 'foton' )         => 'foton_mikado_image_square',
								esc_html__( 'Landscape', 'foton' )      => 'foton_mikado_image_landscape',
								esc_html__( 'Portrait', 'foton' )       => 'foton_mikado_image_portrait',
						...
						array(
							...
							'heading'     => esc_html__( 'Category Tag', 'foton' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Add To Cart Skin', 'foton' ),
							'value'      => array(
								esc_html__( 'Default', 'foton' ) => '',
								esc_html__( 'White', 'foton' )   => 'white',
						...
						array(
							...
							'heading'    => esc_html__( 'Add To Cart Size', 'foton' ),
							'value'      => array(
								esc_html__( 'Default', 'foton' ) => '',
							...
							'dependency' => array( 'element' => 'product_info_type', 'value'   => array( 'foton' ) ),
							'group'      => esc_html__( 'Product Info Style', 'foton' )
						)
					)
				)
