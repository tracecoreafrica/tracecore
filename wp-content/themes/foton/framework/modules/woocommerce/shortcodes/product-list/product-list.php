...
namespace FotonCore\CPT\Shortcodes\ProductList;
...
class ProductList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List', 'foton' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Masonry', 'foton' )  => 'masonry'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Product Info Position', 'foton' ),
							'value'       => array(
								esc_html__( 'Info On Image Hover', 'foton' ) => 'info-on-image',
								esc_html__( 'Info Below Image', 'foton' )    => 'info-below-image'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Skin', 'foton' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Text Alignment', 'foton' ),
							'value'      => array(
								esc_html__( 'Default', 'foton' ) => '',
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Bottom Margin (px)', 'foton' ),
							'dependency' => array( 'element' => 'info_position', 'value'   => array( 'info-below-image' ) ),
							'group'      => esc_html__( 'Product Info Style', 'foton' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_mikado_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list', $params['type'], $params, $additional_params );
