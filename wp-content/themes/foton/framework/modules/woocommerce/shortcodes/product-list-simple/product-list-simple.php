...
namespace FotonCore\CPT\Shortcodes\ProductListSimple;
...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Simple', 'foton' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Sale', 'foton' )         => 'sale',
								esc_html__( 'Best Sellers', 'foton' ) => 'best-sellers',
								esc_html__( 'Featured', 'foton' )     => 'featured'
							),
							'save_always' => true
						),
						array(
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_mikado_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );
