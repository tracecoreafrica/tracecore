<?php
namespace FotonCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'foton' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Minimal', 'foton' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'foton' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'number_of_columns',
						'heading'    => esc_html__( 'Number of Columns', 'foton' ),
					...
					array(
						...
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'foton' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'foton' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'foton' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'foton' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'foton' ),
						'value'      => array_flip( foton_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'foton' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'foton' ),
						'value'      => array_flip( foton_mikado_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'foton' ),
						'value'      => array_flip( foton_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'foton' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'foton' ),
						'value'      => array_flip( foton_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'foton' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'foton' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'foton' ),
						'value'      => array_flip( foton_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'foton' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'foton' ),
						'value'      => array_flip( foton_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'foton' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'foton' ),
						'value'      => array(
							esc_html__( 'None', 'foton' )            => 'no-pagination',
							esc_html__( 'Standard', 'foton' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'foton' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'foton' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'foton' )
					)
				)
			)
		);
