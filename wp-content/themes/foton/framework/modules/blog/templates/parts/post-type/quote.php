...
<div class="mkdf-post-quote-holder">
    <div class="mkdf-post-quote-holder-inner">
        ...
        <?php if(foton_mikado_blog_item_has_link()) { ?>
            <a class="mkdf-post-link-hover" itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"></a>
        <?php } ?>
    </div>
</div>
<?php if($post_author != '') { ?>
    <span class="mkdf-quote-author"><?php echo esc_html($post_author); ?></span>
<?php } ?>