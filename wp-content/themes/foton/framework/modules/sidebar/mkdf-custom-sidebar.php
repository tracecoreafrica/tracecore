...
if ( ! class_exists( 'FotonMikadoClassSidebar' ) ) {
	class FotonMikadoClassSidebar {
		...
		function load_assets() {
			...
			wp_enqueue_script( 'foton-mikado-admin-sidebar-script', MIKADO_ROOT . '/framework/admin/assets/js/mkdf-ui/mkdf-sidebar.js' );
			wp_enqueue_style( 'foton-mikado-admin-sidebar', MIKADO_ROOT . '/framework/admin/assets/css/mkdf-sidebar.css' );
		}
