...
if ( ! function_exists( 'foton_mikado_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function foton_mikado_fonts_options_map() {
		
		foton_mikado_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'foton' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = foton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'foton' )
			)
		);
		
		//H1
		$group_heading_h1 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'foton' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'foton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h1_2 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h1_3 = foton_mikado_add_admin_row(
			array(
		...
		foton_mikado_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top (px)', 'foton' ),
		...
		foton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom (px)', 'foton' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'foton' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'foton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_2 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_3 = foton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'foton' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'foton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_2 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_3 = foton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'foton' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'foton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_2 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_3 = foton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'foton' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'foton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_2 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_3 = foton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'foton' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'foton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_2 = foton_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_3 = foton_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = foton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'foton' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'foton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = foton_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'foton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = foton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'foton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = foton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'foton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = foton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'foton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = foton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'foton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = foton_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = foton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'foton' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = foton_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = foton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = foton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = foton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = foton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = foton_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = foton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'foton' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = foton_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = foton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = foton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = foton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = foton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = foton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = foton_mikado_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = foton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'foton' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'foton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = foton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = foton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$row_text_3 = foton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_3',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Tablet Portrait View)', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for tablet devices - portrait view', 'foton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = foton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'foton' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'foton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = foton_mikado_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = foton_mikado_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'foton' ),
				'description' => esc_html__( 'Define styles for link text', 'foton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = foton_mikado_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		foton_mikado_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'foton' ),
				'parent'        => $row_link_1
			)
		);
		...
		foton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'foton' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = foton_mikado_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		foton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'foton' ),
				'options'       => foton_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		foton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'foton' ),
				'options'       => foton_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'foton_mikado_action_options_map', 'foton_mikado_fonts_options_map', foton_mikado_set_options_map_position( 'fonts' ) );
}